 ...
 */
package org.apache.spark.sql.execution.datasources.index.lucenerdd.analyzers
...
trait AnalyzerConfigurable extends Configurable {
  ...
  private val AnalyzerConfigKey = "org.zouzias.spark.lucenerdd.justtemp.analyzer.name"
