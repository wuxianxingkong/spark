 ...
 */
package org.apache.spark.sql.execution.datasources.index.searchrdd.store
...
import org.apache.spark.sql.execution.datasources.index.searchrdd.config.Configurable
import org.apache.spark.sql.execution.datasources.index.searchrdd.logging.Logging
 ...
 *
 * 1) "org.zouzias.spark.lucenerdd.justtemp.index.store.mode=disk" : MMapStorage on temp disk
...
trait IndexStorable extends Configurable
  ...
  private val IndexStoreKey = "org.zouzias.spark.lucenerdd.justtemp.index.store.mode"
