...
import org.apache.spark.sql.execution.datasources.index.lucenerdd.models.{SparkDoc, SparkFacetResult, SparkScoreDoc}
import org.apache.spark.sql.execution.datasources.index.lucenerdd.response.{LuceneRDDResponse, LuceneRDDResponsePartition}
import org.apache.spark.sql.execution.datasources.index.lucenerdd.spatial.shape.partition.ShapeLuceneRDDPartition
